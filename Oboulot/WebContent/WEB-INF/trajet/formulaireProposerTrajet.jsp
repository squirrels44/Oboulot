	<form method="POST" action="formPropositionTrajet">
			...
			<td>	<label for="nbplace">Nombre de places disponibles<span class="requis">*</span></label> 
				...
				<input type="radio" id="fumeur" name="fumeur" value="NonFumeur" checked>
				...
				<input type="radio" id="musique" name="musique" value="NonMusique" checked>
				...
				<input type="submit" id="submit" name="submit" value="Valider mon trajet" />
