	<form method="POST" action="formPropositionTrajet">
			...
			</td><td>	<input type="text" id="ptpassage" name="ptpassage" onBlur="calculateAndDisplayRoute('ptdepart','ptarrivee')" value="${form['ptpassage']}" /> <span class="error">${erreurs['ptpassage']}</span> <br />
			</td></tr><tr>	
