<form method="POST" action="formRechercheTrajet">
	...
	<div class="form-group row">
        <label class="col-sm-offset-1 col-sm-4">Préférences :</label>
        <div class="row">
			...
			<div class="col-sm-offset-2 col-sm-10">
				<label><input type="radio" id="musique" name="musique" value="NonMusique" >Sans musique</label>
				<label><input type="radio" id="musique" name="musique" value="AvecMusique">Avec musique</label>
			</div>
		</div>
	</div>
	<div class="form-group row">
